...
export const metadata: Metadata = {
  title: "Zona Sur Tech - Stack",
  description: "Nuestra base tecnológica: Next.js 15, Docker y Phoenix Infra. Líderes globales en ingeniería de software de alto rendimiento.",
};
