...
export const metadata: Metadata = {
  title: "Zona Sur Tech - Status",
  description: "Transparencia total: Uptime en tiempo real de nuestros nodos PHX-1. Líderes globales en ingeniería de software de alto rendimiento.",
};
