...
export const metadata: Metadata = {
  title: "Zona Sur Tech - Auth",
  description: "Acceso seguro vía Login Pro Max para el ecosistema global. Líderes globales en ingeniería de software de alto rendimiento.",
};
