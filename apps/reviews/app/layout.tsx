...
export const metadata: Metadata = {
  title: "Zona Sur Tech - Reviews",
  description: "Análisis profundo de software e IA con métricas reales para AdSense. Líderes globales en ingeniería de software de alto rendimiento.",
};
